...
local function Drag(self, mousePressed)
    ...
    if self.isDragged then
        ...
        self.mousePos = self.mousePos + (MouseTracker_GetMouseMovement() / self.background.scale)
        
        Scroll(self:GetParent(), self.mousePos)
...
function SlideBar:Initialize()
    ...
    local eventCallbacks =
    {
        ...
        OnMouseDown = function (self)
            ...
            self.isDragged = true
            self.mousePos = self:GetBackground():GetPosition()
