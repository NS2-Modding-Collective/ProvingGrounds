...
local kSendNoIPsMessageRate = 12
...
function MarineTeam:ResetTeam()
    ...
    self.ipsToConstruct = kInitialInfantryPortals
...
local function SpawnInfantryPortals(self, techPoint)
...
function MarineTeam:SpawnInitialStructures(techPoint)
    ...
    SpawnInfantryPortals(self, techPoint)
