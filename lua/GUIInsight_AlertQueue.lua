...
function GUIInsight_AlertQueue:Initialize()
    ...
    /*
    local icon1 = {Texture = "ui/marine_buildmenu.dds", TextureCoordinates = GetTextureCoordinatesForIcon(kTechId.ShotgunTech, true), Color = Color(1,1,1,0.5), Size = Vector(15,15,0)}
    local info1 = {Text = "TEST", Scale = Vector(0.2,0.2,0.2), Color = Color(0,0,1,0.5), ShadowColor = Color(0,0,0,0.5)}
    local position1 = Vector(0,0,0)   
    alert = self:CreateAlert(position1, icon1, info1, kTeam1Index)
    self:AddAlert(alert, Color(1,1,1,1), Color(1,1,1,1))
    
    local icon2 = {Texture = "ui/alien_buildmenu.dds", TextureCoordinates = GetTextureCoordinatesForIcon(kTechId.Leap, false), Color = Color(0,1,0,0.5), Size = Vector(128,128,0)}
    alert2 = self:CreateAlert(kAlienPosition, icon2, info1, kTeam2Index)
    self:AddAlert(alert2, Color(1,0,0,1), Color(1,1,1,1))
    
    local icon3 = {Texture = "ui/alien_buildmenu.dds", TextureCoordinates = GetTextureCoordinatesForIcon(kTechId.CarapaceShell, false), Color = Color(0,1,0,1), Size = Vector(512,512,0)}
    alert3 = self:CreateAlert(position1, icon3, info1, kTeam2Index)
    self:AddAlert(alert3, Color(1,1,1,0.25), Color(1,0,0,1))
    */
