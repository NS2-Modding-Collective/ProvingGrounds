...
function GetPrereqsAvailable(teamNumber, techId)
    ...
    if techTree then
        ...
        if techNode then
            Print("prereq 1 %s", EnumToString(kTechId, techNode:GetPrereq1()) )
            Print("prereq 2 %s", ToString(techTree:GetHasTech(techNode:GetPrereq2())))
