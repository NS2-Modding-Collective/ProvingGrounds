...
function ARC:AdjustPitchAndRoll()
    ...
    if self:GetCoords() ~= self.lastPitchCoords then
        ...
        local trackPitch = GetPitchFromVector(trackPitchVec) + bodyPitch
        self.forwardTrackPitchDegrees = math.ceil(Clamp(math.deg(trackPitch), -35, 35) * 100) * 0.01
