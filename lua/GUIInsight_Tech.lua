...
local techIdGridPosition =
{
    ...
    [kTechId.ShotgunTech] =         Vector(0, 0, 0),
    [kTechId.MinesTech] =           Vector(1, 0, 0),
    [kTechId.WelderTech] =          Vector(2, 0, 0),
    
    [kTechId.AdvancedArmory] =      Vector(0, 1, 0),
    [kTechId.GrenadeLauncherTech] = Vector(1, 1, 0),
    [kTechId.FlamethrowerTech] =    Vector(2, 1, 0),
...
--  [kTechId.Armor3] =              Vector(1, 2, 0),
    ...
    [kTechId.Spores] =              Vector(2, 0, 0),
    [kTechId.Blink] =               Vector(3, 0, 0),
...
--  [kTechId.PrimalScream] =        Vector(3, 3, 0),
    ...
    [kTechId.RegenerationShell] =   Vector(1, 1, 0),
    [kTechId.CarapaceShell] =       Vector(2, 1, 0),
    
    [kTechId.SilenceVeil] =         Vector(1, 2, 0),
    [kTechId.CamouflageVeil] =      Vector(2, 2, 0),
    [kTechId.FeintVeil] =           Vector(3, 2, 0),

    [kTechId.CeleritySpur] =        Vector(1, 3, 0),
    [kTechId.HyperMutationSpur] =   Vector(2, 3, 0),
    [kTechId.AdrenalineSpur] =      Vector(3, 3, 0)
    ...
    if isMarine then
        ...
        if bit.band(techResearched, GUIInsight_Tech.kRelevantIdMaskMarine[techIdString]) > 0 then
            ...
            elseif self.gUpgradeIcons[techIdString] then -- needed since there may be other research which isn't actually on the grid (like the fake entries)
                ...
                elseif techIdString == "GrenadeLauncherTech" or techIdString == "FlamethrowerTech" then

                    if not AAUp then
                        self.gUpgradeIcons[techIdString]:SetColor(self.kButtonStatusRed)
                    end

                elseif techIdString == "MACEMPTech" then

                    if not roboticsUp then
                        self.gUpgradeIcons[techIdString]:SetColor(self.kButtonStatusRed)
                    end
                    
                elseif techIdString == "PhaseTech" then
        ...
        if bit.band(techResearched, GUIInsight_Tech.kRelevantIdMaskAlien[techIdString]) > 0 then
            ...
            if AlienTier3Strings[techIdString] then
                ...
                elseif techIdString == "Vortex" then
                ...
                elseif techIdString == "Stomp" then
            ...
            elseif AlienTier2Strings[techIdString] then
                ...
                elseif techIdString == "Spores" then
        ...
        elseif bit.band(techResearching, GUIInsight_Tech.kRelevantIdMaskAlien[techIdString]) > 0 then
            ...
            if AlienTier3Strings[techIdString] then
                ...
                elseif techIdString == "PrimalScream" then -- Stomp is T3 right now, maybe Primal will be T2 or T4?
            ...
            if self.gUpgradeIcons[techIdString] then -- needed since there may be other research which isn't actually on the grid (like the fake entries)
