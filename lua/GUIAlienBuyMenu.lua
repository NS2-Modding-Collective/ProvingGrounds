...
local function CreateAbilityIcon(self)
    ...
    graphicItem:SetTexture(GUIAlienBuyMenu.kBuyHUDTexture)
...
function GUIAlienBuyMenu:_UpdateAbilityIcons()
    ...
    local xOffset = GUIAlienBuyMenu.kUpgradeButtonSize * -2
    ...
    for index, abilityItem in ipairs(self.currentAbilities) do
        ...
        if availableAbilities[index] then
            ...
            abilityItem.Icon:SetPosition( Vector(GUIAlienBuyMenu.kUpgradeButtonSize * index + xOffset, 0, 0) )
...
function GUIAlienBuyMenu:_UpdateUpgrades(deltaTime)
    ...
    for i, currentButton in ipairs(self.upgradeButtons) do
        ...
        if not AlienBuy_GetTechAvailable(currentButton.TechId) or (currentButton.Purchased and not self:GetNewLifeFormSelected() ) then
...
/*
    ...
    for i, currentButton in ipairs(self.upgradeButtons) do
        ...
        if currentButton.Selected then
            table.insert(selectedIds, currentButton.TechId)
        end
