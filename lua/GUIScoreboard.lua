...
// Color constants.
GUIScoreboard.kGreenColor = ColorIntToColor(kGreenTeamColor)
GUIScoreboard.kGreenHighlightColor = Color(0.30, 0.69, 1, 1)
GUIScoreboard.kPurpleColor = ColorIntToColor(kPurpleTeamColor)
GUIScoreboard.kPurpleHighlightColor = Color(1, 0.79, 0.23, 1)
...
local function CreateTeamBackground(self, teamNumber)
    ...
    elseif teamNumber == kTeam1Index then
        ...
        color = GUIScoreboard.kGreenColor
    ...
    elseif teamNumber == kTeam2Index then
        ...
        color = GUIScoreboard.kPurpleColor
        teamItem:SetAnchor(GUIItem.Middle, GUIItem.Top)
...
function GUIScoreboard:Initialize()
    ...
    // Green team.
    table.insert(self.teams, { GUIs = CreateTeamBackground(self, kTeam1Index), TeamName = ScoreboardUI_GetGreenTeamName(),
                               Color = GUIScoreboard.kGreenColor, PlayerList = { }, HighlightColor = GUIScoreboard.kGreenHighlightColor,
                               GetScores = ScoreboardUI_GetGreenScores, TeamNumber = kTeam1Index})                              
                       
    // Purple team.
    table.insert(self.teams, { GUIs = CreateTeamBackground(self, kTeam2Index), TeamName = ScoreboardUI_GetPurpleTeamName(),
                               Color = GUIScoreboard.kPurpleColor, PlayerList = { }, HighlightColor = GUIScoreboard.kPurpleHighlightColor,
                               GetScores = ScoreboardUI_GetPurpleScores, TeamNumber = kTeam2Index })
...
function GUIScoreboard:Update(deltaTime)
    ...
    if not self.mouseVisible then
        ...
        local clickForMouseBackgroundVisible = self.visible
    ...
    if self.visible then
        ...
        local playerCount = math.max(#ScoreboardUI_GetGreenScores(), #ScoreboardUI_GetPurpleScores())
