...
local kMessageFontColor = Color(kGreenFontColor.r, kGreenFontColor.g, kGreenFontColor.b, 0)
...
function GUIMarineTeamMessage:Initialize()
    ...
    self.messageText:SetFontName(kGreenFontName)
    ...
    self.messageText:SetColor(kGreenFontColor)
