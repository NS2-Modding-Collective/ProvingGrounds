...
local kMenuTexture =
{
    [kGreenTeamType] = "ui/marine_request_menu.dds",
    [kPurpleTeamType] = "ui/alien_request_menu.dds",
    [kNeutralTeamType] = "ui/neutral_request_menu.dds",
}

local kBackgroundTexture = 
{
    [kGreenTeamType] = "ui/marine_request_button.dds",
    [kPurpleTeamType] = "ui/alien_request_button.dds",
    [kNeutralTeamType] = "ui/neutral_request_button.dds",
}

local kBackgroundTextureHighlight = 
{
    [kGreenTeamType] = "ui/marine_request_button_highlighted.dds",
    [kPurpleTeamType] = "ui/alien_request_button_highlighted.dds",
