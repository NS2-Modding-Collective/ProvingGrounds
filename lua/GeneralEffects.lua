...
kGeneralEffectData = 
{
    ...
    spawn =
    {
        spawnEffects =
        {
            ...
            {cinematic = "cinematics/marine/structures/spawn_building.cinematic", classname = "PowerPack", done = true},
    ...
    death =
    {
        ...
        {
            {cinematic = "cinematics/marine/structures/death_large.cinematic", classname = "Exo", done = true},
