...
kExosuitHealth = 100	kExosuitArmor = 300	kExosuitPointValue = 15
		
kSkulkHealth = 70	kSkulkArmor = 10	kSkulkPointValue = 5
kGorgeHealth = 150	kGorgeArmor = 70	kGorgePointValue = 7
kLerkHealth = 125	kLerkArmor = 25	kLerkPointValue = 15
kFadeHealth = 250	kFadeArmor = 50	kFadePointValue = 20
kOnosHealth = 600	kOnosArmor = 400	kOnosPointValue = 30
		
kEggHealth = 250	kEggArmor = 0	kEggPointValue = 2
kMatureEggHealth = 250	kMatureEggArmor = 25
...
kArmsLabHealth = 2550	kArmsLabArmor = 225	kArmsLabPointValue = 20
...
kExtractorHealth = 4000	kExtractorArmor = 500	kExtractorPointValue = 15

// Harvesters start at -25% of NS1 value and go to +0% (1500/500 = 2500 = NS1)
kHarvesterHealth = 1250	kHarvesterArmor = 300	kHarvesterPointValue = 15
kMatureHarvesterHealth = 1500 kMatureHarvesterArmor = 500 -- NS1

kSentryHealth = 325	kSentryArmor = 100	kSentryPointValue = 10
...
kMatureShellHealth = 600	kMatureShellArmor = 200	kShellPointValue = 10

kCragHealth = 450	kCragArmor = 150	kCragPointValue = 10
kMatureCragHealth = 700	kMatureCragArmor = 350	kMatureCragPointValue = 15
...
kMatureSpurHealth = 600 kMatureSpurArmor = 75 kMatureSpurPointValue = 10

kShiftHealth = 400	kShiftArmor = 50	kShiftPointValue = 10
kMatureShiftHealth = 800	kMatureShiftArmor = 100	kMatureShiftPointValue = 15

kVeilHealth = 500	kVeilArmor = 0	kVeilPointValue = 10
kMatureVeilHealth = 750	kMatureVeilArmor = 0	kVeilPointValue = 10
