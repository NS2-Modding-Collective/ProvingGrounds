...
function GUIInsight_Graphs:Initialize()
    ...
    tabSelected = 1
    tabBars[1] = createTab(0, "Team Kills", graphSize.x)
    ...
    lineGraph:StartLine(kTeam1Index, kGreenColor)
    lineGraph:StartLine(kTeam2Index, kPurpleColor)
    compGraph:SetValues(0,0)
