...
VortexAbleMixin.optionalCallbacks =
{
    ...
    OnVortexEnd = "Called when disruption time is over.",
...
/*
function VortexAbleMixin:OnUpdateAnimationInput(modelMixin)

    PROFILE("VortexAbleMixin:OnUpdateAnimationInput")
    
    modelMixin:SetAnimationInput("disrupt", self:GetIsVortexed())
