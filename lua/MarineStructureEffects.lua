...
kMarineStructureEffects = 
{
    ...
    death =
    {
        marineStructureDeathCinematics =
        {
            ...
            {cinematic = "cinematics/marine/structures/death_small.cinematic", classname = "PowerPack", done = true},
        },
        ...
        marineStructureDeathSounds =
        {
            ...
            {sound = "sound/NS2.fev/marine/structures/generic_death", classname = "PowerPack", done = true},
        },
    },
    ...
    // TODO: Trigger light on MAC housing
    mac_move =
    {
        macMoveEffects = 
        {
