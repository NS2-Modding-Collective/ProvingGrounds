...
// Re-build only possible when 18 seconds have passed after destruction (when aux power kicks in)
local kDestructionBuildDelay = 18
...
function GetPowerPointRecentlyDestroyed(self)
    return self.timeOfDestruction + 15 > Shared.GetTime()
end
...
function PowerPoint:GetCanBeNanoShieldedOverride()
