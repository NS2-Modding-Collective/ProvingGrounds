...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.PowerPack,      [kTechDataHint] = "POWER_PACK_HINT", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataMapName] = PowerPack.kMapName,                [kTechDataDisplayName] = "POWER_PACK",          [kTechDataCostKey] = kPowerPackCost,      [kTechDataPointValue] = kPowerPackPointValue, [kTechDataModel] = PowerPack.kModelName,            [kTechDataBuildTime] = kPowerPackBuildTime, [kTechDataMaxHealth] = kPowerPackHealth,  [kTechDataMaxArmor] = kPowerPackArmor, [kTechDataTooltipInfo] = "POWER_PACK_TOOLTIP", [kTechDataHotkey] = Move.S, [kTechDataNotOnInfestation] = true, [kVisualRange] = PowerPack.kRange },
        ...
        { [kTechDataId] = kTechId.Exosuit,           [kTechDataImplemented] = EXO_ENABLED, [kTechDataDisplayName] = "EXOSUIT", [kTechDataMapName] = "exo",               [kTechDataCostKey] = kExosuitCost, [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "EXOSUIT_TECH_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight},
        { [kTechDataId] = kTechId.DualMinigunExosuit,           [kTechDataImplemented] = EXO_ENABLED, [kTechDataDisplayName] = "DUALMINIGUN_EXOSUIT", [kTechDataMapName] = "exo",               [kTechDataCostKey] = kDualExosuitCost, [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "DUALMINIGUN_EXOSUIT_TECH_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight},
        { [kTechDataId] = kTechId.ExosuitTech,       [kTechDataImplemented] = EXO_ENABLED, [kTechDataDisplayName] = "RESEARCH_EXOSUITS", [kTechDataCostKey] = kExosuitTechResearchCost,  [kTechDataResearchTimeKey] = kExosuitTechResearchTime},
...
,                            
        ...
        // Alien markers
        { [kTechDataId] = kTechId.ThreatMarker,            [kTechDataImplemented] = true,      [kTechDataDisplayName] = "MARK_THREAT",},
        { [kTechDataId] = kTechId.LargeThreatMarker,       [kTechDataImplemented] = true,      [kTechDataDisplayName] = "MARK_THREAT_LARGE",},
        { [kTechDataId] = kTechId.NeedHealingMarker,       [kTechDataImplemented] = true,      [kTechDataDisplayName] = "NEED_HEALING_HERE",},
        { [kTechDataId] = kTechId.WeakMarker,              [kTechDataImplemented] = true,      [kTechDataDisplayName] = "WEAK_HERE",},
        { [kTechDataId] = kTechId.ExpandingMarker,         [kTechDataImplemented] = true,      [kTechDataDisplayName] = "EXPANDING_HERE",},

        { [kTechDataId] = kTechId.NutrientMist, [kTechDataRequiresInfestation] = true, [kTechDataDisplayName] = "NUTRIENT_MIST", [kTechDataCostKey] = kNutrientMistCost, [kTechDataTooltipInfo] =  "NUTRIENT_MIST_TOOLTIP"},
        { [kTechDataId] = kTechId.InfestationSpike, [kTechDataOverrideCoordsMethod] = AlignInfestationSpikes, [kTechDataImplemented] = true, [kTechDataCooldown] = kInfestationSpikeCooldown, [kTechDataMapName] = InfestationSpike.kMapName, [kTechDataModel] = InfestationSpike.kModelName, [kTechDataCollideWithWorldOnly] = true, [kTechDataRequiresInfestation] = true, [kTechDataDisplayName] = "INFESTATION_SPIKE", [kTechDataCostKey] = kInfestationSpikeCost, [kTechDataTooltipInfo] =  "INFESTATION_SPIKE_TOOLTIP"},
