...
function RecycleMixin:OnResearchComplete(researchId)
    ...
    if researchId == kTechId.Recycle then
        ...
        self:GetTeam():PrintWorldTextForTeamInRange(kWorldTextMessageType.Resources, finalRecycleAmount, self:GetOrigin() + kWordMessageResourceOffset, kResourceMessageRange)
