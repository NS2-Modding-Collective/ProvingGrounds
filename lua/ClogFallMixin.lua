...
function ClogFallMixin:TriggerClogFall()
    ...
    local trace = Shared.TraceRay(Vector(origin.x, origin.y + .4, origin.z), Vector(origin.x, origin.y - 100, origin.z), CollisionRep.Default, PhysicsMask.CommanderBuild, EntityFilterAll())
