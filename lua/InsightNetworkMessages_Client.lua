...
function OnCommandReset()
    ...
    if player and player.guiSpectator and player.guiSpectator.guiTech then
        ...
        player.guiSpectator.guiTech.gUpgradeIcons["Spores"]:SetTexturePixelCoordinates(unpack(GetTextureCoordinatesForIcon(kTechId.Spores, false)))
        player.guiSpectator.guiTech.gUpgradeIcons["Blink"]:SetTexturePixelCoordinates(unpack(GetTextureCoordinatesForIcon(kTechId.Blink, false)))
