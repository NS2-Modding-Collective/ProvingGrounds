...
function RoboticsFactory:GetTechButtons(techId)
    ...
    if(techId == kTechId.RootMenu) then
        ...
        local techButtons = {   kTechId.MAC, kTechId.RoboticsFactoryMACUpgradesMenu, kTechId.None, kTechId.None, 
                   kTechId.UpgradeRoboticsFactory, kTechId.None, kTechId.None, kTechId.None }
                   
        if self:GetTechId() == kTechId.ARCRoboticsFactory then
            techButtons[5] = kTechId.ARC
        end
    ...
    elseif techId == kTechId.RoboticsFactoryMACUpgradesMenu then
        return {   kTechId.MACSpeedTech, kTechId.MACEMPTech, kTechId.None, kTechId.None,
                    kTechId.None, kTechId.None, kTechId.None, kTechId.RootMenu }
