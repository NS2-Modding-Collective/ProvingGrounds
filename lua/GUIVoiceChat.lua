...
GUIVoiceChat.kGreenFontColor = Color(147/255, 206/255, 1, 1)
GUIVoiceChat.kPurpleFontColor = Color(207/255, 139/255, 41/255, 1)
...
function GUIVoiceChat:Update(deltaTime)
    ...
    for i = 1, numPlayers do
        ...
        if clientIndex and ChatUI_GetIsClientSpeaking(clientIndex) then
            ...
            local fontColor = GUIVoiceChat.kGreenFontColor
            if PlayerUI_IsOnGreenTeam() then
                textureSet = "alien"
                fontColor = GUIVoiceChat.kPurpleFontColor
            end    
