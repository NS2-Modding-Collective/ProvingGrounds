...
Armory.kArmoryResupplyEnergy = 1
Armory.kArmoryResupplyEnergyRate = .5
Armory.kMaxArmoryResupplyEnergy = 5
...
function Armory:GetTechButtons(techId)
    ...
    if self:GetTechId() == kTechId.Armory then
        ...
        techButtons = { kTechId.ShotgunTech, kTechId.None, kTechId.None, kTechId.None,
                        kTechId.None, kTechId.WelderTech, kTechId.MinesTech, kTechId.None }
