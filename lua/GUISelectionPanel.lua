...
function GUISelectionPanel:InitializeSingleSelectionItems()
    ...
    self.maturity:SetAnchor(GUIItem.Left, GUIItem.Center)
    self.maturity:SetTextAlignmentX(GUIItem.Align_Center)
    self.maturity:SetTextAlignmentY(GUIItem.Align_Center)
    self.maturity:SetPosition(Vector(-18, 0, 0))
    self.maturity:SetText(Locale.ResolveString("MATURITY"))
    
    self.maturityPercentage = GUIManager:CreateTextItem()
    self.maturityPercentage:SetAnchor(GUIItem.Left, GUIItem.Center)
    self.maturityPercentage:SetTextAlignmentX(GUIItem.Align_Center)
    self.maturityPercentage:SetTextAlignmentY(GUIItem.Align_Center)
    self.maturityPercentage:SetPosition(Vector(-18, 10, 0))
    
    self.selectedIcon:AddChild(self.maturityPercentage)
    self.selectedIcon:AddChild(self.maturity)
