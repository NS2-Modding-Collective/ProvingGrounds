...
GUIMinimap.kPlayerOverLaySize = Vector(kBlipSize * 30, kBlipSize * 30, 0)
...
local function PowerPointSpecialCase(blipType, blipColor, underAttack, blipTeam, blipSize, blipLayer)

    PROFILE("PowerPointSpecialCase")
    
    blipColor = kPowerNodeColor
    
    if blipType == kMinimapBlipType.DestroyedPowerPoint then
        blipColor = kDestroyedPowerNodeColor
    elseif underAttack then
        blipColor = GetBlinkAlpha(Shared.GetTime(), blipColor)
    end
    
    local iconCol, iconRow = GetSpriteGridByClass("PowerPoint", ClassToGrid)
    
    return blipColor, iconCol, iconRow, blipSize, kStaticBlipsLayer
...
local function InfestationSpecialCase(blipType, blipColor, underAttack, blipTeam, blipSize, blipLayer)

    PROFILE("InfestationSpecialCase")
    
    blipColor = blipType == kMinimapBlipType.Infestation and kInfestationColor[blipTeam] or kInfestationDyingColor[blipTeam]
    
    local iconCol, iconRow = GetSpriteGridByClass("Infestation", ClassToGrid)
    return blipColor, iconCol, iconRow, blipSize * 2.2, kInfestationBlipsLayer
...
kSpecialCaseStaticBlipModifiers[kMinimapBlipType.PowerPoint] = PowerPointSpecialCase
kSpecialCaseStaticBlipModifiers[kMinimapBlipType.DestroyedPowerPoint] = PowerPointSpecialCase
...
kSpecialCaseStaticBlipModifiers[kMinimapBlipType.Infestation] = InfestationSpecialCase
kSpecialCaseStaticBlipModifiers[kMinimapBlipType.InfestationDying] = InfestationSpecialCase
