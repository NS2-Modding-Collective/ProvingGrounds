 ...
 */
function OptionsDialogUI_SetValues(nickname, mouseSens, screenResIdx, visualDetailIdx, soundVol, musicVol, windowMode, shadows, shadowFading, bloom, atmospherics, anisotropicFiltering, antiAliasing, invMouse, voiceVol)
    ...
    Client.SetOptionBoolean ( kShadowFadingOptionsKey, shadowFading )
