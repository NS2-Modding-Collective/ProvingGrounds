...
kLerkCeleritySpeedModifier = 0.25
kFadeCeleritySpeedModifier = 0.35
...
kHarvesterMaturationTime = 210
kWhipMaturationTime = 120
kCragMaturationTime = 120
kShiftMaturationTime = 120
...
kOnFireEnergyRecuperationScalar = .8
...
kChargeEnergyCost = 22 // per second
...
kDropStructureEnergyCost = 25
kDropClogEnergyCost = 25
kDropCystEnergyCost = 25
