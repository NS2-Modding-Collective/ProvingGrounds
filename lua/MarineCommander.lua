...
function MarineCommander:GetQuickMenuTechButtons(techId)
    ...
    elseif techId == kTechId.AdvancedMenu then 
        ...
        menuButtons = { kTechId.Sentry, kTechId.Observatory, kTechId.PhaseGate, kTechId.PrototypeLab, kTechId.PowerPack, kTechId.None, kTechId.None, kTechId.None}
        
    elseif techId == kTechId.AssistMenu then 
    
        menuButtons = { kTechId.AmmoPack, kTechId.MedPack, kTechId.NanoShield, kTechId.Scan,
                        kTechId.WeaponsMenu, kTechId.None, kTechId.None, kTechId.None}
        
    elseif techId == kTechId.WeaponsMenu then

        menuButtons = { kTechId.DropShotgun, kTechId.DropGrenadeLauncher, kTechId.DropFlamethrower, kTechId.DropWelder,
                        kTechId.DropMines, kTechId.DropJetpack, kTechId.DropExosuit, kTechId.None}
