...
GUINotifications.kAlienColor = Color(1,1,1,1)
...
GUINotifications.kMarineTexture = "ui/marine_tooltips.dds"
...
GUINotifications.kAlienFont = "Candara"
...
function GUINotifications:EnableAlienStyle()
    ...
    self.locationText:SetColor(GUINotifications.kAlienColor)
    self.locationText:SetFontName(GUINotifications.kAlienFont)
    self.tooltipBackground:SetColor(GUINotifications.kTooltipBackgroundColor)
    self.tooltipText:SetColor(GUINotifications.kAlienColor)
