...
{
    [kGreenTeamType] = PrecacheAsset("cinematics/marine/blocker.cinematic"),
    [kPurpleTeamType] = PrecacheAsset("cinematics/alien/blocker.cinematic")
}
